...
final class VerbosePotatoSpec extends AnyFunSuiteLike with Matchers {
  ...
  test("email obfuscation") {
    val validEmails: TableFor2[NonEmptyString, String] = Table(
      ("email", "result"),
    ...
    val invalidEmails: List[NonEmptyString] = List(
      "Abc.example.com",
      "A@b@c@example.com",
  ...
  test("phone number obfuscation") {
    val validPhoneNumbers: TableFor2[NonEmptyString, String] = Table(
      ("phone number", "result"),
    ...
    val invalidPhoneNumbers: List[NonEmptyString] = List(
      "+49 621 60-6641516",
      "+49 621 60-41516",
      "8-1-6641516",
      "61 41516",
